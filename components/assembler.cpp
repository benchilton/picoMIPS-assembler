...
void assembler::write_output_header()
{
  ...
  this->file_output_verilog << "//  - Opcode " << this->opcode_size << "\n";
  this->file_output_verilog << "//  - Registers Address " << this->register_size << "\n";
  this->file_output_verilog << "//  - Jump Address " << this->address_size << "\n";
